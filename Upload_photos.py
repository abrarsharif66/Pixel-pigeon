...
st.markdown("<h1 style='text-align: center; color: grey;'>Pixel Pigeon</h1>", unsafe_allow_html=True)
with st.container():
  left_column, right_column = st.columns(2)
  with left_column:
   st.text(" ")
   st.text("Seamleassly Connect with Your clients!")
...
if no_of_files > 0:
  ...
  with open(PKL_PATH,'wb') as f:
    pkl.dump(encodings_arr,f)
    print("dump hue")""" #disabled for further testing
